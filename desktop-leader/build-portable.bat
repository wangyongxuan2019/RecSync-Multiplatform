...
cls
echo ========================================
echo RecSync Leader - Portable Package Tool
echo ========================================
echo.
...
echo Start program: build\image\bin\RecSync-Leader.bat
echo.
echo You can copy the entire build\image folder to control computers
