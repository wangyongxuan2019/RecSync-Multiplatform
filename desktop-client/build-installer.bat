...
cls
echo ========================================
echo RecSync Client - EXE Installer Package Tool
echo ========================================
echo.
...
echo ========================================
echo.
echo Installer location: build\installer\RecSync-Client-1.0.0.exe
echo.
echo You can distribute this EXE file to other users
echo.
pause
